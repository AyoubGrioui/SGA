			...
			<main class="h-full pb-16 overflow-y-auto">
				<div class="container grid px-6 mx-auto">
					<h2
						...
						Liste des dépenses</h2>
					<h4
						class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
						Information sur les dépenses</h4>
					<!-- Tableau -->
						...
						<div class="w-full overflow-x-auto">
							<table class="w-full whitespace-no-wrap">
								...
								<tbody
									...
									<c:forEach items="${depenseList}" var="depense"
										varStatus="boucle">
												...
												<div class="flex items-center text-sm">
													<div>
														<p class="font-semibold">
															<c:out value="${depense.montant}" />
														</p>
													</div>
												</div>
											</td>
											<td class="px-4 py-3 text-sm"><c:out
													value="${depense.dateDepense}" /></td>
											<td class="px-4 py-3 text-sm"><c:out
													value="${depense.typeDepense}" /></td>
											<td class="px-4 py-3">
												<div class="flex items-center space-x-4 text-sm">

													<a
														href="<c:url value="/modifierDepense"><c:param name="depenseID" value="${depense.idDepense}" /></c:url>">
                                ...
                                <path
														...
														href="<c:url value="/supprimerDepense"><c:param name="depenseID" value="${depense.idDepense}" /></c:url>">
