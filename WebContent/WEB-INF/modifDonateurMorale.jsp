				...
				<form method="POST" action="<c:url value="/modifierDonateur"/>">
					<div class="container px-6 mx-auto grid">
						...
						<div
							...
							<input type="text" hidden="hidden" name="typeDonateur"
								value="morale" /> <input type="text"
								hidden="hidden" name="vue" value="<c:out value="${vue}"/>" />
								...
								<div class="mt-2">
									<div id="nouveauDonateur">
										...
										<label class="mt-4 block text-sm"> <span
											...
											value="<c:out value="${donneur.adresse}" />"></input>
											<span class="text-xs text-red-600 dark:text-red-400">
												<c:out
