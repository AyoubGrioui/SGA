			...
			<div class="flex flex-col overflow-y-auto md:flex-row">
				...
				<div class="h-32 md:h-auto md:w-1/2">
					...
					<img aria-hidden="true"
						...
						src="assets/img/login-adherent-light.jpg" alt="Office" />
					<!--image en dark mode-->
					<img aria-hidden="true"
						class="hidden object-cover w-full h-full dark:block"
						src="assets/img/login-adherent-dark.jpg" alt="Office" />
				</div>
				...
				<div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
						...
						<form method="post" action="<c:url value="/loginAdherent"/>">
							...
							<label class="block text-sm">
								...
								<span class="text-xs text-red-600 dark:text-red-400"> <c:out
										value="${loginAdherentForm.erreurs['userEmail']}" />
							</span>
                  ...
                  value="<c:out value="${empty userAdherent.motDePasse ?password:userAdherent.motDePasse }"/>" />
								<span class="text-xs text-red-600 dark:text-red-400"> <c:out
										value="${loginAdherentForm.erreurs['userPassword']}" />
							</span>
