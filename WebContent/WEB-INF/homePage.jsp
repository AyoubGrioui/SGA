...
<style>
.slide-in-bottom {
	-webkit-animation: slide-in-bottom .5s cubic-bezier(.25, .46, .45, .94)
		both;
...
.slide-in-bottom-subtitle {
	-webkit-animation: slide-in-bottom .5s cubic-bezier(.25, .46, .45, .94)
		.75s both;
	animation: slide-in-bottom .5s cubic-bezier(.25, .46, .45, .94) .75s
		both
}

.fade-in {
	-webkit-animation: fade-in 1.2s cubic-bezier(.39, .575, .565, 1.000) 1s
		both;
...
@
-webkit-keyframes slide-in-bottom { 0%{
...
<body class="leading-normal tracking-normal text-gray-900"
	...
	<div class="h-screen pb-14 bg-right bg-cover"
		...
		<div class="w-full container mx-auto p-6">
			...
			<div class="w-full flex items-center justify-between">
				<a
					...
					href="#"> Gestion Des Associations </a>
		...
		<!--Main-->
		<div
			class="container  px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
			...
			<div
				...
				<p
					class="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">Se
					connecter comme étant :</p>
			...
			<div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
				<img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom"
					src="assets/img/homePage.svg">
			</div>

			<!--Footer-->
			<div class="w-full pb-6 text-sm text-center md:text-left fade-in">
				<a class="text-gray-500 no-underline hover:no-underline" href="#">&copy;
					2021-Gestion Association. All rights reserved</a>
			</div>
